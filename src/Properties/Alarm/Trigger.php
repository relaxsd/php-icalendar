...
abstract class Trigger
{
    ...
    const DEFAULT_VALUE_TYPE = ValueDataType::VALUETYPE_DURATION;
     ...
     */
    public static function createRelative($duration, $related = AlarmTriggerRelationShip::RELATED_START)
    {
        return new RelativeTrigger($duration, $related);
    }

    /**
     * @param \DateTime|string $dateTime
     *
     * @return \Relaxsd\ICalendar\Properties\Alarm\AbsoluteTrigger
     */
    public static function createAbsolute(DateTime $dateTime)
    {
        return new AbsoluteTrigger($dateTime);
    }
