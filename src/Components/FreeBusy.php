...
use Relaxsd\ICalendar\Properties\DateTime\Traits\HasFreeBusies;
...
use Relaxsd\ICalendar\Properties\Relationship\Traits\HasContact;
 ...
 */
class FreeBusy implements Writable
{
