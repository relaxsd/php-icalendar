...
use Relaxsd\ICalendar\Properties\Alarm\Traits\HasAction;
use Relaxsd\ICalendar\Properties\Alarm\Traits\HasTrigger;
 ...
 */
class Alarm implements Writable
{
    use HasAction,
        HasTrigger;

    // Other properties, see subclasses
     ...
     */
    public function __construct($action, $trigger = null)
    {
    ...
    //abstract function acceptWriter(Writer $formatter);
